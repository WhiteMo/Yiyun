...
<%
	...
	article.setImgUrl(request.getParameter("ImgUrl"));
	article.setShortContent(request.getParameter("ShortContent"));
	article.setTag(request.getParameter("Tag"));
