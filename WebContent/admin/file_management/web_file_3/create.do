<!DOCTYPE html>
<!-- saved from url=(0063)http://111.230.147.160:8080/jsp/cmscp/core/web_file_3/create.do -->
...
<div class="content">
	<div class="box box-primary">
		<form class="form-horizontal" id="validForm" action="http://111.230.147.160:8080/jsp/cmscp/core/web_file_3/save.do" method="post" novalidate="novalidate">
			...
			<div class="box-header with-border">
				<div class="btn-toolbar">
					<div class="btn-group">
						...
						<button class="btn btn-default" type="button" onclick="location.href=&#39;create.do?parentId=&amp;&#39;;" disabled="disabled">新增</button>
						
					</div>
					<div class="btn-group">
						
						<button class="btn btn-default" type="button" onclick="location.href=&#39;create.do?cid=&amp;parentId=&amp;&#39;;" disabled="disabled">复制</button>
						
						
						<button class="btn btn-default" type="button" onclick="if(confirmDelete()){location.href=&#39;delete.do?ids=&amp;parentId=&amp;&#39;;}" disabled="disabled">删除</button>
						
					</div>
					<div class="btn-group">
						<button class="btn btn-default" type="button" onclick="location.href=&#39;edit.do?id=&amp;position=-1&amp;parentId=&amp;&#39;;" disabled="disabled">上一条</button>
						<button class="btn btn-default" type="button" onclick="location.href=&#39;edit.do?id=&amp;position=1&amp;parentId=&amp;&#39;;" disabled="disabled">下一条</button>
					</div>
					<div class="btn-group">
						<button class="btn btn-default" type="button" onclick="location.href=&#39;list.do?parentId=&amp;&#39;;">返回</button>
					</div>				
				</div>
			</div>
			<div class="box-body">
