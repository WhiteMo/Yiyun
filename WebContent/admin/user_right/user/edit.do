<!DOCTYPE html>
<!-- saved from url=(0072)http://111.230.147.160:8080/jsp/cmscp/core/user/edit.do?id=0&position=2& -->
...
<link rel="stylesheet" href="./edit_files/bootstrap.min.css">
<link rel="stylesheet" href="./edit_files/font-awesome.min.css">
<link rel="stylesheet" href="./edit_files/ionicons.min.css">
<link rel="stylesheet" href="./edit_files/jquery-ui.css">
<link rel="stylesheet" href="./edit_files/jquery.minicolors.css">
<link rel="stylesheet" href="./edit_files/metroStyle.css">
<link rel="stylesheet" href="./edit_files/AdminLTE.min.css">
<link rel="stylesheet" href="./edit_files/skin-blue.min.css">
<link rel="stylesheet" href="./edit_files/process.css">
<link rel="stylesheet" href="./edit_files/editormd.min.css">
<link rel="stylesheet" href="./edit_files/main.css">
<!--[if lt IE 9]>
...
<script src="./edit_files/jquery.min.js.下载"></script>
<script src="./edit_files/bootstrap.min.js.下载"></script>
<script src="./edit_files/jquery-ui.js.下载"></script>
<script src="./edit_files/jquery-validation.min.js.下载"></script>
<script src="./edit_files/jquery.validation_zh_CN.js.下载"></script>
<script src="./edit_files/jquery-form.min.js.下载"></script>
<script src="./edit_files/jquery-ajaxfileuploader.min.js.下载"></script>
<script src="./edit_files/jquery.minicolors.min.js.下载"></script>
<script src="./edit_files/jquery-cookie.min.js.下载"></script>
<script src="./edit_files/jquery.ztree.all.min.js.下载"></script>
<script src="./edit_files/cn_WdatePicker.js.下载"></script><link href="./edit_files/WdatePicker.css" rel="stylesheet" type="text/css">
<script src="./edit_files/swfupload.js.下载"></script>
<script src="./edit_files/swfupload.queue.js.下载"></script>
<script src="./edit_files/fileprogress.js.下载"></script>
<script src="./edit_files/handlers.js.下载"></script>
<script src="./edit_files/ueditor.config.js.下载"></script>
<script src="./edit_files/ueditor.all.min.js.下载"></script>
<script src="./edit_files/zh-cn.js.下载"></script>
<script src="./edit_files/editormd.min.js.下载"></script>
<script src="./edit_files/editormd.plugin.js.下载"></script>
<script src="./edit_files/to-markdown.js.下载"></script>
<script src="./edit_files/echarts.common.min.js.下载"></script>
<script src="./edit_files/plugins.js.下载"></script>
<script src="./edit_files/jspxcms_choose.js.下载"></script>
<script>
$(function() {
	$("#validForm").validate();
...
<div class="content">
	<div class="box box-primary">
		<form class="form-horizontal" id="validForm" action="http://111.230.147.160:8080/jsp/cmscp/core/user/update.do" method="post" novalidate="novalidate">
			...
			<div class="box-header with-border">
				<div class="btn-toolbar">
					<div class="btn-group">
						...
						<button class="btn btn-default" type="button" onclick="location.href=&#39;create.do?orgId=1&amp;&#39;;">新增</button>
						
						
						<button class="btn btn-default" type="button" onclick="location.href=&#39;create.do?id=0&amp;&#39;;">复制</button>
						
					</div>
					<div class="btn-group">
						
						<button class="btn btn-default" type="button" onclick="if(confirmDelete()){location.href=&#39;delete.do?ids=0&amp;&#39;;}" disabled="disabled">删除</button>
						
					</div>
					<div class="btn-group">
						<button class="btn btn-default" type="button" onclick="location.href=&#39;edit.do?id=1&amp;position=1&amp;&#39;;">上一条</button>
						<button class="btn btn-default" type="button" onclick="location.href=&#39;edit.do?id=&amp;position=3&amp;&#39;;" disabled="disabled">下一条</button>
					</div>
					<div class="btn-group">
			...
			<div class="box-body">
	            ...
	            <div class="col-sm-8">
	            	<input type="text" id="username" name="username" value="anonymous" class="form-control {required:true,remote:{url:&#39;check_username.do&#39;,type:&#39;post&#39;,data:{original:&#39;anonymous&#39;}},messages:{remote:&#39;用户名已存在&#39;}}">
	            </div>
	          </div>
					</div>
					<div class="col-sm-6">
	            ...
	            <div class="col-sm-8">
								<label class="radio-inline"><input type="radio" value="M" name="gender" checked="checked">男</label>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
	            <label for="creationDate" class="col-sm-4 control-label"><em class="required">*</em>创建时间</label>
	            <div class="col-sm-8">
	            	<input type="text" id="creationDate" name="creationDate" value="2013-03-09T22:18:56" onclick="WdatePicker({dateFmt:&#39;yyyy-MM-ddTHH:mm:ss&#39;});" class="form-control required">
	            </div>
	          </div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
	            <label for="creationIp" class="col-sm-4 control-label"><em class="required">*</em>创建IP</label>
	            <div class="col-sm-8">
								<input type="text" id="creationIp" name="creationIp" value="127.0.0.1" maxlength="100" class="form-control required">
	            </div>
	          </div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
	            <label for="prevLoginDate" class="col-sm-4 control-label">上次登录时间</label>
	            <div class="col-sm-8">
	            	<input type="text" id="prevLoginDate" name="prevLoginDate" class="form-control" value="" onclick="WdatePicker({dateFmt:&#39;yyyy-MM-ddTHH:mm:ss&#39;});">
	            </div>
	          </div>
					</div>
					<div class="col-sm-6">
						<div class="form-group">
	            <label for="prevLoginIp" class="col-sm-4 control-label">上次登录IP</label>
	            <div class="col-sm-8">
								<input type="text" id="prevLoginIp" name="prevLoginIp" maxlength="100" class="form-control">
	            </div>
	          </div>
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
	            <label for="logins" class="col-sm-2 control-label">登录次数</label>
	            <div class="col-sm-10">
	            	<input type="text" id="logins" name="logins" value="0" maxlength="10" class="form-control digits">
	            </div>
	          </div>
					</div>
				</div>
