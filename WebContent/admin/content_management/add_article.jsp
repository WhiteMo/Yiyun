			...
			<form class="form-horizontal" method="post" novalidate="novalidate"
								...
								<div class="col-sm-10">
									...
									<div class="input-group" id="linkDiv"
										...
										<input type="text" id="link" name="link" maxlength="255"
											...
											<span class="in-prompt" title="x"></span>
										</span>
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<label class="checkbox-inline"> <!--多选框  --> <input
										type="checkbox" name="attr" value="h">热点推荐
									</label> <label class="checkbox-inline"> <!--多选框  --> <input
										type="checkbox" name="attr" value="n">最新课程
									</label>
										...
										<div style="display: table-cell; vertical-align: middle;">
											...
											<div class="form-inline" style="margin-top: 3px;">
												...
												<input type="file" id="fileToUpload" name="fileToUpload"
													onchange="changePic()" accept="image/*"
				...
				<div class="box-footer">
					...
					<button class="btn btn-default"
						onclick="saveAndExit()">保存并返回</button>
					<button class="btn btn-default" onclick="saveAndAdd()">保存并新增</button>
				</div>
