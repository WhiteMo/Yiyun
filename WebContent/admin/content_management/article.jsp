...
<%
	...
	Article[] articles = aImpl.getAllArticles();
...
function confirmDelete(id) {
	...
	if(flag==true){
		$.post(basePath+"/ArticleAction",{type:"delete",id:id},function(result){
			if(result=='success'){
				location.reload();
			}
		})
					...
					<div class="btn-toolbar ls-btn-bar">
						<div class="btn-group">
							...
							<button class="btn btn-default" type="button"
								onclick="location.href='add_article.jsp'">新增</button>
							...
							<c:forEach var="article" items="${articles}">
								<tr>
									<td><input type="checkbox" name="ids"
										value="${article.id}"></td>
									<td align="center"><a
										href="${basePath}/admin/content_management/update_article.jsp?id=${article.id}" class="ls-opt">修改</a>
									...
									<td align="center">
										<div>
											<a href="h#" target="_blank">已发布</a>
										</div>
										<div>
											html: <a href="#" class="ls-opt" style=""> 未开启 </a>
										</div>
									</td>
								</tr>
							</c:forEach>
				...
				<form method="get" class="ls-page">
					...
					<div class="pull-left" style="padding: 0 6px;">
						&nbsp;每页 <select class="form-control" id="pageSize"
							onchange="$.cookie(&#39;page_size&#39;,$(this).val(),{expires:36500});this.form.submit();"
