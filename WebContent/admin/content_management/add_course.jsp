		...
		<div class="box box-primary" style="">
			<form class="form-horizontal" method="post" novalidate="novalidate"
				...
				<div class="box-footer">
					<button class="btn btn-primary" onclick="addCourse('stay')">保存</button>
					<button class="btn btn-default" onclick="addCourse('back')">保存并返回</button>
					<button class="btn btn-default" onclick="addCourse('add')">保存并新增</button>
				</div>
