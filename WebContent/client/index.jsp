...
<link
	...
	rel="stylesheet">
<link href="${basePath}/client/css/homepage.css" type="text/css" rel="stylesheet">
<link href="${basePath}/client/css/shouyetou.css" type="text/css" rel="stylesheet">
<!-- Bootstrap core CSS -->
<link href="${basePath}/client/css/bootstrap.min.css" type="text/css" rel="stylesheet">
<link rel="stylesheet"  type="text/css" href="${basePath}/client/css/owl.carousel.css">
<link rel="stylesheet" type="text/css" href="${basePath}/client/css/owl.theme.css">
<link rel="icon" href="${basePath}/client/image/header_brand_image.png"
	type="image/x-icon" />
<!-- Custom styles for this template -->
<link href="${basePath}/client/css/carousel.css" type="text/css" rel="stylesheet">
